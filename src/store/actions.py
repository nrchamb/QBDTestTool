...
# UI state actions
def set_create_sash_ratio(ratio: float) -> Dict[str, Any]:
    """Create SET_CREATE_SASH_RATIO action."""
    return {'type': 'SET_CREATE_SASH_RATIO', 'payload': ratio}


def set_monitor_sash_ratio(ratio: float) -> Dict[str, Any]:
    """Create SET_MONITOR_SASH_RATIO action."""
    return {'type': 'SET_MONITOR_SASH_RATIO', 'payload': ratio}
