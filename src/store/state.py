...
class InvoiceRecord:
    ...
    balance_remaining: float = None  # Current balance (None = same as amount)
...
class AppState:
    ...
    # UI state - sash positions (ratio 0.0-1.0, None = use default 0.8)
    create_log_sash_ratio: float = None
    monitor_log_sash_ratio: float = None
