...
def start_monitoring(app):
    ...
    # Require deposit account to be selected
    if not state.expected_deposit_account:
        messagebox.showwarning("Deposit Account Required",
            "Please select an Expected Deposit Account before starting monitoring.\n\n"
            "This is used to validate that payments are deposited to the correct account.")
        return
