            ...
            if not activity_log_collapsed:
                if hasattr(app, 'create_paned'):
                    try:
                        ...
                        if paned_height > 100:
                            create_sash_pos = app.create_paned.sash_coord(0)[1] / paned_height
                            print(f"Saving create log sash ratio: {create_sash_pos:.3f}")
                    except Exception as e:
                ...
                if hasattr(app, 'monitor_paned'):
                    try:
                        ...
                        if paned_height > 100:
                            monitor_sash_pos = app.monitor_paned.sash_coord(0)[1] / paned_height
                            print(f"Saving monitor log sash ratio: {monitor_sash_pos:.3f}")
                    except Exception as e:
